############################
#
#       The below file is used to define the registration conversation with a user interested in placing
#       the bot into their personal server. Each step below must be followed in succession.
#
############################
...
class Register(object):
    ...
    async def step_1(self, args):
        if 'banana' not in args: #### SECRET CODE WORD IS "BANANA" TO ENSURE USER HAS COMPLETELY READ THE DOCUMENTATION ON THE BOT. Description for TSA.
